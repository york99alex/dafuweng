-----远古禁地
if nil == Card_MONSTER_ancient_forbidden_land then
    -----@class Card_MONSTER_ancient_forbidden_land : Card
    Card_MONSTER_ancient_forbidden_land = class({}, nil, Card)
end

-----远古禁地~
-----@type Card_MONSTER_ancient_forbidden_land
local this = Card_MONSTER_ancient_forbidden_land
...
function this:CastFilterResult()
    print("Card_MONSTER_ancient_forbidden_land~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
...
function this:OnSpellStart()
    ...
    -----@type Path
    local paths = PathManager:getPathByType(TP_MONSTER_3)
    for i = 1, #paths do
