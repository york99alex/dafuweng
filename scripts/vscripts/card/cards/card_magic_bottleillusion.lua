-----幻象神符
if nil == Card_MAGIC_BottleIllusion then
    ---@class Card_MAGIC_BottleIllusion : Card
    Card_MAGIC_BottleIllusion = class({}, nil, Card)
end

---@type Card_MAGIC_BottleIllusion
local this = Card_MAGIC_BottleIllusion
...
function this:OnSpellStart()
    ...
    path:onRune(owner, DOTA_RUNE_ILLUSION)
end