-----小型狩猎场
if nil == Card_MONSTER_small_hunting_ground then
    -----@class Card_MONSTER_small_hunting_ground : Card 分则能成
    Card_MONSTER_small_hunting_ground = class({}, nil, Card)
end

-----小型狩猎场~
-----@type Card_MONSTER_small_hunting_ground
local this = Card_MONSTER_small_hunting_ground
...
function this:CastFilterResult()
    print("Card_MONSTER_small_hunting_ground~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
...
function this:OnSpellStart()
    ...
    local paths = PathManager:getPathByType(TP_MONSTER_1)
    for i = 1, #paths do
