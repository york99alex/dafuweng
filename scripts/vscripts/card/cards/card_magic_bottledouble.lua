-----双倍神符
if nil == Card_MAGIC_BottleDouble then
    ---@class Card_MAGIC_BottleDouble : Card
    Card_MAGIC_BottleDouble = class({}, nil, Card)
end

---@type Card_MAGIC_BottleDouble
local this = Card_MAGIC_BottleDouble
...
function this:OnSpellStart()
    ...
    path:onRune(owner, DOTA_RUNE_DOUBLEDAMAGE)
end