-----极速神符
if nil == Card_MAGIC_BottleHaste then
    ---@class Card_MAGIC_BottleHaste : Card
    Card_MAGIC_BottleHaste = class({}, nil, Card)
end

---@type Card_MAGIC_BottleHaste
local this = Card_MAGIC_BottleHaste
...
function this:OnSpellStart()
    ...
    path:onRune(owner, DOTA_RUNE_HASTE)
end