-----赏金神符
if nil == Card_MAGIC_BottleBounty then
    ---@class Card_MAGIC_BottleBounty : Card
    Card_MAGIC_BottleBounty = class({}, nil, Card)
end

---@type Card_MAGIC_BottleBounty
local this = Card_MAGIC_BottleBounty
...
function this:OnSpellStart()
    ...
    path:onRune(owner, DOTA_RUNE_BOUNTY)
end