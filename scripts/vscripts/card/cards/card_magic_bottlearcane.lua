-----奥术神符
if nil == Card_MAGIC_BottleArcane then
    ---@class Card_MAGIC_BottleArcane : Card
    Card_MAGIC_BottleArcane = class({}, nil, Card)
end

---@type Card_MAGIC_BottleArcane
local this = Card_MAGIC_BottleArcane
...
function this:OnSpellStart()
    ...
    path:onRune(owner, DOTA_RUNE_ARCANE)
end